...
class WorkoutCreateExerciseAdapter(
...
) : RecyclerView.Adapter<WorkoutCreateExerciseAdapter.ExerciseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExerciseViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_workout_create_exercise, parent, false)
    ...
    inner class ExerciseViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val equip: TextView = view.findViewById(R.id.text_view_workout_create_exercise_equipment)
        ...
        fun bind(exercise: Exercise) {
            ...
            exercise.sets.forEachIndexed { index, set ->
                val setView = LayoutInflater.from(setsContainer.context)
                    .inflate(R.layout.item_workout_create_exercise_set, setsContainer, false)
